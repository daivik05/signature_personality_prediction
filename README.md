...
- **notebooks**: 
  - `signature personaltiy prediction3.ipynb`: Notebook for creating and training the classification model.
  - `sign_test_2.ipynb`: Notebook for setting up the connection between Colab and the mobile app.
- **README.md**: This file.
